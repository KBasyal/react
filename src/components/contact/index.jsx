                ...
                <section className="bg-gray-100 py-12 px-4">
                    ...
                    <form className="max-w-2xl mx-auto mt-8 space-y-8">
                        <div>
                            ...
                            <input type="text" id="name" className="w-full mt-2 p-3 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-gray-500 transition" />
                        </div>
                        <div>
                            <label htmlFor="email" className="block text-gray-700 font-bold">Email</label>
                            <input type="email" id="email" className="w-full mt-2 p-3 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-gray-500 transition" />
                        </div>
                        <div>
                            <label htmlFor="message" className="block text-gray-700 font-bold">Message</label>
                            <textarea id="message" rows="5" className="w-full mt-2 p-3 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-gray-500 transition"></textarea>
                        </div>
                        <button type="submit" className="w-full bg-gray-700 text-white py-3 rounded-lg shadow-lg hover:bg-gray-600 transition-colors">Send Message</button>
                    </form>
                </section>
                <section className="text-center py-12 px-4">
